...
var CurrentUser = (function () {
    function CurrentUser(firstName, lastName, level) {
...
var current_user = new current_user_1.CurrentUser('Adam', 'Lund', 400);
var menu_factory = new menuitem_model_1.MenuItemFactory();
/** Order of operations */
...
axios_1.default.get('./features.json').then(function (res) {
...
},{"./current.user":28,"./menuitem.model":30,"axios":1}],30:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var MenuItem = (function () {
    ...
    MenuItem.prototype.getAsElement = function () {
        if (this.url) {
...
var MenuItemFactory = (function () {
    ...
    MenuItemFactory.prototype.makeNavItem = function (item) {
        var _this = this;
        if (item.label) {
            var e = document.createElement('li');
            var m = new MenuItem(item.label, item.url || null);
            e.appendChild(m.getAsElement());
            if (item.features) {
                var sublist_1 = document.createElement('ul');
                Object.keys(item.features).forEach(function (key) {
                    var subnavitem = _this.makeNavItem(item.features[key]);
                    if (subnavitem) {
                        sublist_1.appendChild(subnavitem);
                    }
                });
                e.appendChild(sublist_1);
            }
            return e;
        }
        else {
