...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var spokhubnav_1 = require("./spokhubnav");
...
var spokNav = new spokhubnav_1.SpokHubNavBar('navigation');

},{"./spokhubnav":31}],30:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
var SpokHubNavBar = (function () {
    function SpokHubNavBar(rootSelector) {
        // Ordinarily first thing is to get the current user
        this.current_user = new current_user_1.CurrentUser('Adam', 'Lund', 400);
        this.menu_factory = new menuitem_model_1.MenuItemFactory();
        this.navigation_selector = rootSelector;
        this.initFeatureMenu();
    }
    SpokHubNavBar.prototype.initFeatureMenu = function () {
        var _this = this;
        var leftnavitems = document.createElement('div');
        var navlist = document.createElement('ul');
        leftnavitems.className = "menu-left";
        /** This would call a service over http to GET the features object  */
        axios_1.default.get('/config-nav.json').then(function (res) {
            Object.keys(res.data).forEach(function (item) {
                var menu = _this.menu_factory.makeNavItem(res.data[item]);
                navlist.appendChild(menu);
            });
            leftnavitems.appendChild(navlist);
            document.getElementById(_this.navigation_selector).appendChild(leftnavitems);
            _this.initUserMenu();
        });
    };
    SpokHubNavBar.prototype.initUserMenu = function () {
        var _this = this;
        var user_profile_menu = {
            user: {
